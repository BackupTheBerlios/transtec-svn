...
public class DeplacerColis implements KeyListener{
	...
	public DeplacerColis(Bouton aEcouter,float benne_profondeur,float benne_hauteur,float benne_largeur,Vector vect){
		b = aEcouter;
